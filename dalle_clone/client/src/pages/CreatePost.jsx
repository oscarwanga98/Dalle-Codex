  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 tetxt-[#666e75] text-[16px] max-w[500px]'>Create imaginateive and visually staernig images and share them </p>
      </div>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-5 flex gap-5'>
          <button
            ...
            className='text-white bg-green-700 font-medium rounded-medium text-sm w-full sm:w-auto px-5 py-2.5 text-center '
          >
            {generatingImg? 'Generating...':'Generate'}
          </button>
        </div>
        <div className='mt-10'>
          <p className='mt-2 text-[#666e75] text-[14px]'>Once you have created the image you can share with others in the community</p>
          <button
            type='submit'
